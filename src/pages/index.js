    ...
    <div className="min-h-screen transition-colors duration-300 bg-gray-900/95 backdrop-blur-sm border-b border-gray-700">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-start"> {/* Changed items-center to items-start for better top alignment */}
              <div>
                <h3 className="text-2xl font-bold mb-6 text-gray-800 dark:text-white">
                  Hello! I&apos;m Hamza Ansari, a passionate developer crafting digital experiences.
                </h3>
              ...
              <div className="space-y-6 md:pl-8"> {/* Added padding to the right column for separation */}
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:sayedusaid49@gmail.com" className="text-blue-600 dark:text-blue-400 hover:underline">hamzaansari26110@gmail.com</a>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="space-y-4 text-left md:text-center md:flex md:flex-col md:items-center">
              <div className="flex items-center space-x-3">
                ...
                <a href="mailto:sayedusaid49@gmail.com" className="text-gray-800 dark:text-white hover:underline">hamzaansari26110@gmail.com</a>
              </div>
              <div className="flex items-center space-x-3">
                <PhoneIcon className="h-6 w-6 text-blue-600" />
                <span className="text-gray-800 dark:text-white">9769850785</span>
              </div>
              <div className="flex items-center space-x-3">
      ...
      <footer className="bg-gray-900 text-white py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p>&copy; 2025 Hamza Ansari. All rights reserved.</p>
        </div>
      </footer>
